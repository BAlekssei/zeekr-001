.class public Lcom/ecarx/eas/sdk/user/UserProxy;
.super Lcom/ecarx/eas/sdk/user/UserAPI;
.source "SourceFile"


# static fields
.field private static final TAG:Ljava/lang/String; = "UserProxy"

.field private static userProxy:Lcom/ecarx/eas/framework/sdk/Singleton;
...
# instance fields
.field private volatile mApi:Lcom/ecarx/eas/sdk/user/InternalUserAPI;

.field private volatile mContext:Landroid/content/Context;

.field private volatile mPackageName:Ljava/lang/String;

.field private mV3Binder:Landroid/os/IBinder;
...
.method static constructor <clinit>()V
    ...
    .line 32
    new-instance v0, Lcom/ecarx/eas/sdk/user/UserProxy$1;

    invoke-direct {v0}, Lcom/ecarx/eas/sdk/user/UserProxy$1;-><init>()V

    sput-object v0, Lcom/ecarx/eas/sdk/user/UserProxy;->userProxy:Lcom/ecarx/eas/framework/sdk/Singleton;
...
.method public constructor <init>()V
    ...
    .line 30
    invoke-direct {p0}, Lcom/ecarx/eas/sdk/user/UserAPI;-><init>()V

    return-void
.end method

.method static synthetic access$000(Lcom/ecarx/eas/sdk/user/UserProxy;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;)V
    .locals 0
    .param p0, "x0"    # Lcom/ecarx/eas/sdk/user/UserProxy;
    ...
    .end local p0    # "x0":Lcom/ecarx/eas/sdk/user/UserProxy;
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/ecarx/eas/sdk/user/UserProxy;->initUser(Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;)V

    return-void
.end method

.method static synthetic access$100(Lcom/ecarx/eas/sdk/user/UserProxy;)Lcom/ecarx/eas/sdk/user/InternalUserAPI;
    .locals 0
    .param p0, "x0"    # Lcom/ecarx/eas/sdk/user/UserProxy;
    ...
    .end local p0    # "x0":Lcom/ecarx/eas/sdk/user/UserProxy;
    iget-object p0, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mApi:Lcom/ecarx/eas/sdk/user/InternalUserAPI;

    return-object p0
.end method

.method static synthetic access$200(Lcom/ecarx/eas/sdk/user/UserProxy;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/safeparcel/ServiceVersionInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/ecarx/eas/sdk/user/UserProxy;
    .param p1, "x1"    # Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;
    ...
    invoke-direct {p0, p1, p2}, Lcom/ecarx/eas/sdk/user/UserProxy;->initUser(Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/safeparcel/ServiceVersionInfo;)V

    return-void
.end method

.method public static get()Lcom/ecarx/eas/sdk/user/UserProxy;
    .locals 1

    .line 44
    sget-object v0, Lcom/ecarx/eas/sdk/user/UserProxy;->userProxy:Lcom/ecarx/eas/framework/sdk/Singleton;

    invoke-virtual {v0}, Lcom/ecarx/eas/framework/sdk/Singleton;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/ecarx/eas/sdk/user/UserProxy;
...
.method private initUser(Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;)V
    ...
    iget-object v3, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mPackageName:Ljava/lang/String;
    ...
    .line 142
    :cond_1
    iput-object p1, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mV3Binder:Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mContext:Landroid/content/Context;

    invoke-static {p2, v0, p3}, Lcom/ecarx/eas/sdk/UserFactory;->createUserAPIFactory(Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Landroid/content/Context;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;)Lcom/ecarx/eas/sdk/user/InternalUserAPI;

    move-result-object p2

    iput-object p2, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mApi:Lcom/ecarx/eas/sdk/user/InternalUserAPI;
    ...
    .line 146
    iget-object p2, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mApi:Lcom/ecarx/eas/sdk/user/InternalUserAPI;
    ...
    .line 195
    .end local p0    # "this":Lcom/ecarx/eas/sdk/user/UserProxy;
    iget-object p2, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mApi:Lcom/ecarx/eas/sdk/user/InternalUserAPI;
...
.method private initUser(Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/safeparcel/ServiceVersionInfo;)V
    ...
    invoke-direct {p0, p1, p2, p2}, Lcom/ecarx/eas/sdk/user/UserProxy;->initUser(Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;)V
    ...
    .line 84
    .restart local p0    # "this":Lcom/ecarx/eas/sdk/user/UserProxy;
    .restart local p1    # "openAPIServiceType":Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;
    ...
    invoke-direct {p0, p1, v0, v0}, Lcom/ecarx/eas/sdk/user/UserProxy;->initUser(Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;Lcom/ecarx/eas/framework/sdk/common/internal/ClientType;)V
...
.method public getAccessToken()Ljava/lang/String;
    ...
    .line 224
    iget-object v0, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mApi:Lcom/ecarx/eas/sdk/user/InternalUserAPI;
    ...
    invoke-interface {v0}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->getAccessToken()Ljava/lang/String;
...
.method public getBinder()Landroid/os/IBinder;
    ...
    .line 201
    iget-object v0, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mV3Binder:Landroid/os/IBinder;
...
.method public getLoginUser()Lcom/ecarx/eas/sdk/user/IUser;
    ...
    invoke-interface {v0}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->getLoginUser()Lcom/ecarx/eas/sdk/user/IUser;
...
.method public getRefreshToken()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->getRefreshToken()Ljava/lang/String;
...
.method public hasLogin()Z
    ...
    invoke-interface {v0}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->hasLogin()Z
...
.method public init(Landroid/content/Context;Lcom/ecarx/eas/sdk/ECarXApiClient$Callback;)V
    ...
    .line 50
    invoke-super {p0, p1, p2}, Lcom/ecarx/eas/sdk/user/UserAPI;->init(Landroid/content/Context;Lcom/ecarx/eas/sdk/ECarXApiClient$Callback;)V

    .line 51
    iput-object p1, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/ecarx/eas/sdk/user/UserProxy;->mPackageName:Ljava/lang/String;
    ...
    new-instance v2, Lcom/ecarx/eas/sdk/user/UserProxy$2;

    .line 54
    .end local p0    # "this":Lcom/ecarx/eas/sdk/user/UserProxy;
    invoke-direct {v2, p0}, Lcom/ecarx/eas/sdk/user/UserProxy$2;-><init>(Lcom/ecarx/eas/sdk/user/UserProxy;)V
...
.method public launchLogin()Z
    ...
    invoke-interface {v0}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->launchLogin()Z
...
.method public launchLogin(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->launchLogin(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public login(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->login(Ljava/lang/String;)Ljava/lang/String;
...
.method public logout()Ljava/lang/Boolean;
    ...
    invoke-interface {v0}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->logout()Ljava/lang/Boolean;
...
.method public notifyRefreshTokenExpired()Z
    ...
    invoke-interface {v0}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->notifyRefreshTokenExpired()Z
...
.method public notifyTokenExpired()Z
    ...
    invoke-interface {v0}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->notifyTokenExpired()Z
...
.method public setLoginCallback(Lcom/ecarx/eas/sdk/user/callback/LoginCallback;)Z
    ...
    invoke-interface {v0, p1}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->setLoginCallback(Lcom/ecarx/eas/sdk/user/callback/LoginCallback;)Z
...
.method public unregisterLoginCallback(Lcom/ecarx/eas/sdk/user/callback/LoginCallback;)Z
    ...
    .end local p1    # "callback":Lcom/ecarx/eas/sdk/user/callback/LoginCallback;
    invoke-interface {v0, p1}, Lcom/ecarx/eas/sdk/user/InternalUserAPI;->unregisterLoginCallback(Lcom/ecarx/eas/sdk/user/callback/LoginCallback;)Z
