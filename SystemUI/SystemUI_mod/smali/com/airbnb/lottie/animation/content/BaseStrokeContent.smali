...
.method private applyTrimPath(Landroid/graphics/Canvas;Lcom/airbnb/lottie/animation/content/BaseStrokeContent$PathGroup;Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {v4, v5, v2}, Landroid/graphics/Path;->addPath(Landroid/graphics/Path;Landroid/graphics/Matrix;)V
    ...
    .line 224
    .local v5, "animEndValue":F
    invoke-static/range {p2 .. p2}, Lcom/airbnb/lottie/animation/content/BaseStrokeContent$PathGroup;->access$200(Lcom/airbnb/lottie/animation/content/BaseStrokeContent$PathGroup;)Lcom/airbnb/lottie/animation/content/TrimPathContent;

    move-result-object v4

    invoke-virtual {v4}, Lcom/airbnb/lottie/animation/content/TrimPathContent;->getOffset()Lcom/airbnb/lottie/animation/keyframe/BaseKeyframeAnimation;
    ...
    .line 229
    const-string v6, "StrokeContent#applyTrimPath"
    ...
    .line 239
    .local v7, "offsetLength":F
    mul-float v9, v6, v3

    add-float/2addr v9, v7

    .line 240
    .local v9, "startLength":F
    mul-float v10, v6, v5
    ...
    .line 242
    .local v10, "endLength":F
    const/4 v11, 0x0

    .line 243
    .local v11, "currentLength":F
    invoke-static/range {p2 .. p2}, Lcom/airbnb/lottie/animation/content/BaseStrokeContent$PathGroup;->access$100(Lcom/airbnb/lottie/animation/content/BaseStrokeContent$PathGroup;)Ljava/util/List;
    ...
    check-cast v15, Lcom/airbnb/lottie/animation/content/PathContent;

    invoke-interface {v15}, Lcom/airbnb/lottie/animation/content/PathContent;->getPath()Landroid/graphics/Path;
    ...
    invoke-virtual {v14, v15, v8}, Landroid/graphics/PathMeasure;->setPath(Landroid/graphics/Path;Z)V
    ...
    invoke-static {v12, v15, v8, v2}, Lcom/airbnb/lottie/utils/Utils;->applyTrimPathIfNeeded(Landroid/graphics/Path;FFF)V

    .line 260
    iget-object v2, v0, Lcom/airbnb/lottie/animation/content/BaseStrokeContent;->trimPathPath:Landroid/graphics/Path;

    iget-object v12, v0, Lcom/airbnb/lottie/animation/content/BaseStrokeContent;->paint:Landroid/graphics/Paint;

    invoke-virtual {v1, v2, v12}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    .line 261
    .end local v8    # "endValue":F
    .end local v15    # "startValue":F
    goto :goto_6
    ...
    invoke-static {v12, v2, v8, v15}, Lcom/airbnb/lottie/utils/Utils;->applyTrimPathIfNeeded(Landroid/graphics/Path;FFF)V
...
.method public draw(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    invoke-virtual {v2, v1}, Lcom/airbnb/lottie/model/layer/BaseLayer;->getBlurMaskFilter(F)Landroid/graphics/BlurMaskFilter;

    move-result-object v2

    .line 183
    .local v2, "blur":Landroid/graphics/BlurMaskFilter;
    ...
    .line 185
    .end local v2    # "blur":Landroid/graphics/BlurMaskFilter;
    :cond_4
    :goto_0
    ...
    :cond_5
    iget-object v1, p0, Lcom/airbnb/lottie/animation/content/BaseStrokeContent;->dropShadowAnimation:Lcom/airbnb/lottie/animation/keyframe/DropShadowKeyframeAnimation;
    ...
    invoke-virtual {v1, v2}, Lcom/airbnb/lottie/animation/keyframe/DropShadowKeyframeAnimation;->applyTo(Landroid/graphics/Paint;)V
