...
.method protected varargs doInBackground([Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    .local v12, "currentUserInfo":Landroid/content/pm/UserInfo;
    ...
    .line 206
    .end local v12    # "currentUserInfo":Landroid/content/pm/UserInfo;
    ...
    .end local v8    # "currentUserInfo":Landroid/content/pm/UserInfo;
    .restart local v12    # "currentUserInfo":Landroid/content/pm/UserInfo;
    :cond_2
    ...
    .restart local v13    # "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    :cond_5
    move-object v1, v11
    ...
    .end local v26    # "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    .local v1, "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    goto :goto_8

    .line 234
    .end local v1    # "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    .restart local v26    # "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    :cond_b
    move-object/from16 v1, v26

    .end local v26    # "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    .restart local v1    # "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    :goto_8
    ...
    .line 239
    .local v23, "systemCanCreateUsers":Z
    if-eqz v12, :cond_e
    ...
    .line 243
    .local v24, "currentUserCanCreateUsers":Z
    if-eqz v23, :cond_f
    ...
    .line 244
    .local v25, "anyoneCanCreateUsers":Z
    if-nez v24, :cond_10
    ...
    .end local v12    # "currentUserInfo":Landroid/content/pm/UserInfo;
    .local v28, "currentUserInfo":Landroid/content/pm/UserInfo;
    move v13, v15
    ...
    .line 260
    .end local v13    # "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    .end local v28    # "currentUserInfo":Landroid/content/pm/UserInfo;
    .restart local v1    # "guestRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    .restart local v12    # "currentUserInfo":Landroid/content/pm/UserInfo;
    :cond_14
    move-object/from16 v28, v12
    ...
    .end local v12    # "currentUserInfo":Landroid/content/pm/UserInfo;
    .restart local v28    # "currentUserInfo":Landroid/content/pm/UserInfo;
    ...
    .line 269
    .local v1, "addUserRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    iget-object v4, v0, Lcom/android/systemui/statusbar/policy/UserSwitcherController$1;->this$0:Lcom/android/systemui/statusbar/policy/UserSwitcherController;
    ...
    .line 273
    .end local v1    # "addUserRecord":Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;
    :cond_17
    return-object v5
.end method
