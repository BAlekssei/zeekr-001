...
public interface ZeekrRefreshLayout {
     ...
     */
    ZeekrRefreshLayout setFooterHeight(float dp);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setFooterHeightPx(int px);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setHeaderHeight(float dp);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setHeaderHeightPx(int px);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setHeaderInsetStart(float dp);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setHeaderInsetStartPx(int px);

    /**
     * Set the Footer's start offset.
     * 设置 Footer 起始偏移量（用处和 setHeaderInsetStart 一样）
     * @see ZeekrRefreshLayout#setHeaderInsetStart(float)
     * @param dp Density-independent Pixels 虚拟像素（px需要调用px2dp转换）
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setFooterInsetStart(float dp);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setFooterInsetStartPx(int px);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setDragRate(@FloatRange(from = 0, to = 1) float rate);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setHeaderMaxDragRate(@FloatRange(from = 1, to = 10) float rate);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setFooterMaxDragRate(@FloatRange(from = 1, to = 10) float rate);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setHeaderTriggerRate(@FloatRange(from = 0, to = 1.0) float rate);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setFooterTriggerRate(@FloatRange(from = 0, to = 1.0) float rate);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setReboundInterpolator(@NonNull Interpolator interpolator);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setReboundDuration(int duration);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setRefreshFooter(@NonNull ZeekrRefreshFooter footer);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setRefreshFooter(@NonNull ZeekrRefreshFooter footer, int width, int height);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setRefreshHeader(@NonNull ZeekrRefreshHeader header);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setRefreshHeader(@NonNull ZeekrRefreshHeader header, int width, int height);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setRefreshContent(@NonNull View content);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setRefreshContent(@NonNull View content, int width, int height);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableRefresh(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableLoadMore(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableAutoLoadMore(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableHeaderTranslationContent(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableFooterTranslationContent(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableOverScrollBounce(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnablePureScrollMode(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableScrollContentWhenLoaded(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableScrollContentWhenRefreshed(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableLoadMoreWhenContentNotFull(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableOverScrollDrag(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableFooterFollowWhenNoMoreData(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableClipHeaderWhenFixedBehind(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableClipFooterWhenFixedBehind(boolean enabled);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setEnableNestedScroll(boolean enabled);
    /**
     * 设置固定在 Header 下方的视图Id，可以在 Footer 上下滚动的时候保持不跟谁滚动
     * @param id 固定在头部的视图Id
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setFixedHeaderViewId(@IdRes int id);
    /**
     * 设置固定在 Footer 上方的视图Id，可以在 Header 上下滚动的时候保持不跟谁滚动
     * @param id 固定在底部的视图Id
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setFixedFooterViewId(@IdRes int id);
    /**
     * 设置在 Header 上下滚动时，需要跟随滚动的视图Id，默认整个内容视图
     * @param id 固定在头部的视图Id
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setHeaderTranslationViewId(@IdRes int id);
    /**
     * 设置在 Footer 上下滚动时，需要跟随滚动的视图Id，默认整个内容视图
     * @param id 固定在头部的视图Id
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setFooterTranslationViewId(@IdRes int id);
    /**
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setDisableContentWhenRefresh(boolean disable);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setDisableContentWhenLoading(boolean disable);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setOnRefreshListener(ZeekrOnRefreshListener listener);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setOnLoadMoreListener(ZeekrOnLoadMoreListener listener);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setOnRefreshLoadMoreListener(ZeekrOnRefreshLoadMoreListener listener);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setOnMultiListener(ZeekrOnMultiListener listener);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setScrollBoundaryDecider(ZeekrScrollBoundaryDecider boundary);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setPrimaryColors(@ColorInt int... primaryColors);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishRefresh();
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishRefresh(int delayed);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishRefresh(boolean success);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishRefresh(int delayed, boolean success, Boolean noMoreData);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishRefreshWithNoMoreData();
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishLoadMore();
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishLoadMore(int delayed);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishLoadMore(boolean success);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishLoadMore(int delayed, boolean success, boolean noMoreData);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout finishLoadMoreWithNoMoreData();
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout closeHeaderOrFooter();
     ...
     *      use {@link ZeekrRefreshLayout#resetNoMoreData()}
     *      use {@link ZeekrRefreshLayout#finishRefreshWithNoMoreData()}
     *      use {@link ZeekrRefreshLayout#finishLoadMoreWithNoMoreData()}
     */
    ZeekrRefreshLayout setNoMoreData(boolean noMoreData);
     ...
     * @return RefreshLayout
     */
    ZeekrRefreshLayout resetNoMoreData();
     ...
     */
    @Nullable
    ZeekrRefreshHeader getRefreshHeader();
     ...
     */
    @Nullable
    ZeekrRefreshFooter getRefreshFooter();
