...
public class ZeekrScrollBoundaryHorizontal extends ZeekrSimpleBoundaryDecider{
    ...
    public static boolean canRefresh(@NonNull View targetView, PointF touch) {
        ...
        if (targetView instanceof ViewGroup && touch != null) {
            ...
            for (int i = childCount; i > 0; i--) {
                ...
                if (ZeekrSmartUtil.isTransformedTouchPointInView(viewGroup, child, touch.x, touch.y, point)) {
