...
public enum ZeekrRefreshState {
    ...
    ZeekrRefreshState(int role, boolean dragging, boolean opening, boolean finishing, boolean twoLevel, boolean releaseToOpening) {
    ...
    public ZeekrRefreshState toFooter() {
    ...
    public ZeekrRefreshState toHeader() {
