...
.method constructor <init>(Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;Ljava/lang/String;Ljava/util/concurrent/TimeUnit;J)V
    ...
    iput-object p3, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$14;->val$timeUnit:Ljava/util/concurrent/TimeUnit;

    iput-wide p4, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$14;->val$startTime:J
...
.method public run()V
    ...
    new-instance v3, Lcom/sensorsdata/analytics/android/sdk/internal/beans/EventTimer;

    iget-object v4, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$14;->val$timeUnit:Ljava/util/concurrent/TimeUnit;

    iget-wide v5, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$14;->val$startTime:J

    invoke-direct {v3, v4, v5, v6}, Lcom/sensorsdata/analytics/android/sdk/internal/beans/EventTimer;-><init>(Ljava/util/concurrent/TimeUnit;J)V
